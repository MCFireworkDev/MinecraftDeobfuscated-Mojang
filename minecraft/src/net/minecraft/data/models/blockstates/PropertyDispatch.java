...
public abstract class PropertyDispatch {
	...
	protected void putValue(Selector selector, List<Variant> list) {
		List<Variant> list2 = (List)this.values.put(selector, list);
		if (list2 != null) {
	...
	private void verifyComplete() {
		...
		List<Selector> list2 = (List)stream.filter(selector -> !this.values.containsKey(selector)).collect(Collectors.toList());
		if (!list2.isEmpty()) {
					...
					comparable -> this.property2
							...
							.forEach(
								comparable2 -> this.property3
										.getPossibleValues()
										.forEach(comparable3 -> this.select((T1)comparable, (T2)comparable2, (T3)comparable3, triFunction.apply(comparable, comparable2, comparable3)))
							)
				);
			return this;
		}
					...
					comparable -> this.property2
							...
							.forEach(
								comparable2 -> this.property3
										.getPossibleValues()
										.forEach(
											comparable3 -> this.select((T1)comparable, (T2)comparable2, (T3)comparable3, (List<Variant>)triFunction.apply(comparable, comparable2, comparable3))
										)
							)
				);
			return this;
											...
											comparable3 -> this.property4
													...
													.forEach(
														comparable4 -> this.select(
																(T1)comparable, (T2)comparable2, (T3)comparable3, (T4)comparable4, quadFunction.apply(comparable, comparable2, comparable3, comparable4)
															)
													)
										)
							)
											...
											comparable3 -> this.property4
													...
													.forEach(
														comparable4 -> this.select(
																...
																(T3)comparable3,
																(T4)comparable4,
																(List<Variant>)quadFunction.apply(comparable, comparable2, comparable3, comparable4)
															)
													)
										)
							)
														...
														comparable4 -> this.property5
																...
																.forEach(
																	comparable5 -> this.select(
																			...
																			(T4)comparable4,
																			(T5)comparable5,
																			pentaFunction.apply(comparable, comparable2, comparable3, comparable4, comparable5)
																		)
																)
													)
										)
														...
														comparable4 -> this.property5
																...
																.forEach(
																	comparable5 -> this.select(
																			...
																			(T4)comparable4,
																			(T5)comparable5,
																			(List<Variant>)pentaFunction.apply(comparable, comparable2, comparable3, comparable4, comparable5)
																		)
																)
													)
										)
