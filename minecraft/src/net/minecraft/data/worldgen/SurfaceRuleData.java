...
public class SurfaceRuleData {
	...
	public static SurfaceRules.RuleSource overworldLike(boolean bl, boolean bl2, boolean bl3) {
		...
		SurfaceRules.RuleSource ruleSource7 = SurfaceRules.sequence(
			...
			SurfaceRules.ifTrue(
				SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue(conditionSource12, STONE), ruleSource5, SNOW_BLOCK)
			),
		...
		SurfaceRules.RuleSource ruleSource8 = SurfaceRules.sequence(
			...
			SurfaceRules.ifTrue(
				SurfaceRules.isBiome(Biomes.SNOWY_SLOPES), SurfaceRules.sequence(SurfaceRules.ifTrue(conditionSource12, STONE), ruleSource6, SNOW_BLOCK)
			),
		...
		return SurfaceRules.sequence((SurfaceRules.RuleSource[])builder.build().toArray(i -> new SurfaceRules.RuleSource[i]));
	}
