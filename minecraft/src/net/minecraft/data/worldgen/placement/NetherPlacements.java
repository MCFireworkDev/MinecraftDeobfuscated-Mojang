...
public class NetherPlacements {
	public static final PlacedFeature DELTA = PlacementUtils.register(
		"delta", NetherFeatures.DELTA.placed(CountOnEveryLayerPlacement.of(40), BiomeFilter.biome())
	);
	...
	public static final PlacedFeature BLACKSTONE_BLOBS = PlacementUtils.register(
		"blackstone_blobs",
		NetherFeatures.BLACKSTONE_BLOBS.placed(CountPlacement.of(25), InSquarePlacement.spread(), PlacementUtils.FULL_RANGE, BiomeFilter.biome())
	);
