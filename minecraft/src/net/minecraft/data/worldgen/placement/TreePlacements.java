...
public class TreePlacements {
	...
	public static final PlacedFeature OAK_BEES_002 = PlacementUtils.register(
		"oak_bees_002", TreeFeatures.OAK_BEES_002.filteredByBlockSurvival(Blocks.OAK_SAPLING)
	);
