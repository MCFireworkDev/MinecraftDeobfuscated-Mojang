...
public class RecipeProvider implements DataProvider {
	...
	private static final Map<BlockFamily.Variant, BiFunction<ItemLike, ItemLike, RecipeBuilder>> shapeBuilders = ImmutableMap.builder()
		...
		.put(BlockFamily.Variant.CHISELED, (BiFunction)(itemLike, itemLike2) -> chiseledBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.CUT, (BiFunction)(itemLike, itemLike2) -> cutBuilder(itemLike, Ingredient.of(itemLike2)))
		...
		.put(BlockFamily.Variant.SLAB, (BiFunction)(itemLike, itemLike2) -> slabBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.STAIRS, (BiFunction)(itemLike, itemLike2) -> stairBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.PRESSURE_PLATE, (BiFunction)(itemLike, itemLike2) -> pressurePlateBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.POLISHED, (BiFunction)(itemLike, itemLike2) -> polishedBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.TRAPDOOR, (BiFunction)(itemLike, itemLike2) -> trapdoorBuilder(itemLike, Ingredient.of(itemLike2)))
		.put(BlockFamily.Variant.WALL, (BiFunction)(itemLike, itemLike2) -> wallBuilder(itemLike, Ingredient.of(itemLike2)))
		.build();
	...
	private static void generateRecipes(Consumer<FinishedRecipe> consumer, BlockFamily blockFamily) {
		blockFamily.getVariants().forEach((variant, block) -> {
			BiFunction<ItemLike, ItemLike, RecipeBuilder> biFunction = (BiFunction)shapeBuilders.get(variant);
