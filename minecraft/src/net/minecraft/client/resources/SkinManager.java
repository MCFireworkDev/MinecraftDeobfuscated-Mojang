...
public class SkinManager {
	...
	public CompletableFuture<PlayerSkin> getOrLoad(GameProfile gameProfile) {
		return (CompletableFuture<PlayerSkin>)this.skinCache.getUnchecked(new SkinManager.CacheKey(gameProfile));
	}
	...
	static record CacheKey(GameProfile profile) {
		public boolean equals(Object object) {
			if (!(object instanceof SkinManager.CacheKey)) {
				...
				SkinManager.CacheKey cacheKey = (SkinManager.CacheKey)object;
				return this.profile.getId().equals(cacheKey.profile.getId()) && Objects.equals(this.texturesData(), cacheKey.texturesData());
			}
		}
	...
	static class TextureCache {
		...
		public CompletableFuture<ResourceLocation> getOrLoad(MinecraftProfileTexture minecraftProfileTexture) {
			...
			CompletableFuture<ResourceLocation> completableFuture = (CompletableFuture)this.textures.get(string);
