...
public class MetricSampler {
	...
	private <T> MetricSampler(
		Metric metric, DoubleSupplier doubleSupplier, @Nullable Runnable runnable, @Nullable MetricSampler.ThresholdAlerter thresholdAlerter
	) {
		this.metric = metric;
