...
public class CubeListBuilder {
	...
	public CubeListBuilder addBox(String string, float f, float g, float h, int i, int j, int k, CubeDeformation cubeDeformation, int l, int m) {
		...
		this.cubes
			.add(
				new CubeDefinition(string, (float)this.xTexOffs, (float)this.yTexOffs, f, g, h, (float)i, (float)j, (float)k, cubeDeformation, this.mirror, 1.0F, 1.0F)
			);
		return this;
	}
	...
	public CubeListBuilder addBox(String string, float f, float g, float h, int i, int j, int k, int l, int m) {
		...
		this.cubes
			.add(
				new CubeDefinition(
					string, (float)this.xTexOffs, (float)this.yTexOffs, f, g, h, (float)i, (float)j, (float)k, CubeDeformation.NONE, this.mirror, 1.0F, 1.0F
				)
			);
		return this;
	}
