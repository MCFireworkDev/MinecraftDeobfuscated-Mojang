...
public class Options {
	...
	private void processOptions(Options.FieldAccess fieldAccess) {
		...
		this.ambientOcclusion
			.set(
				(AmbientOcclusionStatus)fieldAccess.process(
					"ao",
					(AmbientOcclusionStatus)this.ambientOcclusion.get(),
					Options::readAmbientOcclusion,
					ambientOcclusionStatus -> Integer.toString(ambientOcclusionStatus.getId())
				)
			);
		this.prioritizeChunkUpdates
			.set(
				(PrioritizeChunkUpdates)fieldAccess.process(
					"prioritizeChunkUpdates", (PrioritizeChunkUpdates)this.prioritizeChunkUpdates.get(), PrioritizeChunkUpdates::byId, PrioritizeChunkUpdates::getId
				)
			);
