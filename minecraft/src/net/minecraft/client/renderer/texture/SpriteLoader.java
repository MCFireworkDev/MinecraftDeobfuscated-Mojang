		...
		return this.loadSpriteContents(map, executor)
			.thenApplyAsync(
				list -> {
					...
					Map<ResourceLocation, TextureAtlasSprite> mapxx = this.getStitchedSprites(stitcher);
					TextureAtlasSprite textureAtlasSprite = (TextureAtlasSprite)mapxx.get(MissingTextureAtlasSprite.getLocation());
					...
					return new SpriteLoader.Preparations(stitcher.getWidth(), stitcher.getHeight(), m, textureAtlasSprite, mapxx, completableFuture);
				},
				executor
			);
	}
