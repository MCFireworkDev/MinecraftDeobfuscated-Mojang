...
public class PlayerRenderer extends LivingEntityRenderer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
	...
	private void renderHand(
		...
		if (abstractClientPlayer.getCarried() == LivingEntity.Carried.MOB) {
			...
			modelPart.zRot += (modelPart == playerModel.rightArm ? 30.0F : -30.0F) * (float) (Math.PI / 180.0);
			modelPart2.xRot -= (float) (Math.PI / 6);
			modelPart2.zRot += (modelPart2 == playerModel.rightSleeve ? 30.0F : -30.0F) * (float) (Math.PI / 180.0);
		}
