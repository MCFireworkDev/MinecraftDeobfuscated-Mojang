		...
		if (bl instanceof ArmorItem armorItem) {
			if (armorItem.getSlot() == equipmentSlot) {
				...
				if (armorItem instanceof DyeableArmorItem) {
					...
					this.renderModel(poseStack, multiBufferSource, i, armorItem, bl2, humanoidModel, blx, f, g, h, null);
					this.renderModel(poseStack, multiBufferSource, i, armorItem, bl2, humanoidModel, blx, 1.0F, 1.0F, 1.0F, "overlay");
				} else {
					this.renderModel(poseStack, multiBufferSource, i, armorItem, bl2, humanoidModel, blx, 1.0F, 1.0F, 1.0F, null);
				}
