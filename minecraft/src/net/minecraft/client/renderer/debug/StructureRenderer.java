...
public class StructureRenderer implements DebugRenderer.SimpleDebugRenderer {
	...
	public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, double d, double e, double f) {
		...
		Map<String, StructuresDebugPayload.PieceInfo> map = (Map)this.postPieces.get(resourceKey);
		if (map != null) {
	...
	public void addBoundingBox(BoundingBox boundingBox, List<StructuresDebugPayload.PieceInfo> list, ResourceKey<Level> resourceKey) {
		...
		Map<String, StructuresDebugPayload.PieceInfo> map = (Map)this.postPieces.computeIfAbsent(resourceKey, resourceKeyx -> new HashMap());
