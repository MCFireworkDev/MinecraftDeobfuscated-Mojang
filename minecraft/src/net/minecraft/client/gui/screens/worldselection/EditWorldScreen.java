...
public class EditWorldScreen extends Screen {
	...
	protected void init() {
		...
		Button button = this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 24 + 5, 200, 20, I18n.get("selectWorld.edit.resetIcon"), buttonx -> {
			LevelStorageSource levelStorageSourcexx = this.minecraft.getLevelSource();
			FileUtils.deleteQuietly(levelStorageSourcexx.getFile(this.levelId, "icon.png"));
