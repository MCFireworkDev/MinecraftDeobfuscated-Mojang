...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
	...
	protected void init() {
		...
		for(int i = 0; i <= 2; ++i) {
			...
			for(int l = 0; l < j; ++l) {
				Holder<MobEffect> holder = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(i)).get(l);
		...
		for(int l = 0; l < j - 1; ++l) {
			Holder<MobEffect> holder = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(3)).get(l);
			BeaconScreen.BeaconPowerButton beaconPowerButton = new BeaconScreen.BeaconPowerButton(
		...
		Holder<MobEffect> holder2 = (Holder)((List)BeaconBlockEntity.BEACON_EFFECTS.get(0)).get(0);
