...
public class TitleScreen extends Screen {
	...
	private void createNormalMenuOptions(int i, int j) {
		this.addButton(
			new Button(
				this.width / 2 - 100, i, 200, 20, new TranslatableComponent("menu.singleplayer"), button -> this.minecraft.setScreen(new SelectWorldScreen(this))
			)
		);
			...
			new Button(
				...
				button -> {
					...
					try (LevelStorageSource.LevelStorageAccess levelStorageAccess = levelStorageSource.createAccess("Demo_World")) {
						WorldData worldDataxx = levelStorageAccess.getDataTag();
						if (worldDataxx != null) {
							this.minecraft
								.setScreen(
									new ConfirmScreen(
										...
										new TranslatableComponent("selectWorld.deleteWarning", worldDataxx.getLevelName()),
