...
public abstract class Option {
	...
	public static final ProgressOption CHAT_SCALE = new ProgressOption(
		"options.chat.scale", 0.0, 1.0, 0.0F, options -> options.chatScale, (options, double_) -> {
	...
	public static final ProgressOption CHAT_WIDTH = new ProgressOption(
		"options.chat.width", 0.0, 1.0, 0.0F, options -> options.chatWidth, (options, double_) -> {
	...
	public static final ProgressOption CHAT_DELAY = new ProgressOption(
		...
		6.0,
		0.1F,
		options -> options.chatDelay,
		(options, double_) -> options.chatDelay = double_,
		(options, progressOption) -> {
	...
	public static final CycleOption<String> AUDIO_DEVICE = CycleOption.create(
		"options.audioDevice",
		(Supplier)(() -> Stream.concat(Stream.of(""), Minecraft.getInstance().getSoundManager().getAvailableSoundDevices().stream()).toList()),
		string -> {
			if ("".equals(string)) {
