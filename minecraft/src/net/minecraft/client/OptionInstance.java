...
public final class OptionInstance<T> {
	...
	public static OptionInstance<Boolean> createBoolean(
		...
		return new OptionInstance(string, function, boolean_ -> boolean_ ? CommonComponents.OPTION_ON : CommonComponents.OPTION_OFF, BOOLEAN_VALUES, (T)bl, consumer);
	}
	...
	public AbstractWidget createButton(Options options, int i, int j, int k) {
		OptionInstance.TooltipSupplier<T> tooltipSupplier = (OptionInstance.TooltipSupplier)this.tooltip.apply(Minecraft.getInstance());
