...
public class OptionInstance<T> extends Option {
	...
	public static OptionInstance<Boolean> createBoolean(
		...
		return new OptionInstance<>(
			...
			new OptionInstance.Enum<>(ImmutableList.of((T)Boolean.TRUE, (T)Boolean.FALSE)),
			(T)bl,
			consumer
		);
	}
	...
	public AbstractWidget createButton(Options options, int i, int j, int k) {
		Option.TooltipSupplier<T> tooltipSupplier = (Option.TooltipSupplier)this.tooltip.apply(Minecraft.getInstance());
