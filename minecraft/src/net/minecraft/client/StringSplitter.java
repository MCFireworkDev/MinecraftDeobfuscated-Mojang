...
public class StringSplitter {
	...
	public void splitLines(String string, int i, Style style, boolean bl, StringSplitter.LinePosConsumer linePosConsumer) {
		...
		StringSplitter.LineBreakFinder lineBreakFinder;
		for(Style style2 = style; j < k; style2 = lineBreakFinder.getSplitStyle()) {
			lineBreakFinder = new StringSplitter.LineBreakFinder((float)i);
