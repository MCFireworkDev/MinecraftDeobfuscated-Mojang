...
public class GameTestBatchRunner {
	...
	private void runBatch(int i) {
		...
		if (i < this.batches.size()) {
			...
			Collection<GameTestInfo> collection = (Collection)this.testInfosPerBatch.get(string);
	...
	private void spawnTestStructures(GameTestBatch gameTestBatch) {
		Collection<GameTestInfo> collection = (Collection)this.testInfosPerBatch.get(gameTestBatch.getName());
