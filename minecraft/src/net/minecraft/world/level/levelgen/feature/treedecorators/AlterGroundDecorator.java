...
public class AlterGroundDecorator extends TreeDecorator {
	...
	private void placeBlockAt(
		LevelSimulatedReader levelSimulatedReader, BiConsumer<BlockPos, BlockState> biConsumer, RandomSource randomSource, BlockPos blockPos
	) {
		for(int i = 2; i >= -3; --i) {
