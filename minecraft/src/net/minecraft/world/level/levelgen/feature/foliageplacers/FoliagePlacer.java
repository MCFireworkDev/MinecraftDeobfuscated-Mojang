...
public abstract class FoliagePlacer implements Serializable {
	...
	protected void placeLeaf(
		LevelSimulatedRW levelSimulatedRW, Random random, BlockPos blockPos, SmallTreeConfiguration smallTreeConfiguration, Set<BlockPos> set
	) {
