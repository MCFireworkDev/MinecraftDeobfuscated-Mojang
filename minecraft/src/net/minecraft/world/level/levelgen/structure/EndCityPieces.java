...
public class EndCityPieces {
	...
	static final EndCityPieces.SectionGenerator TOWER_GENERATOR = new EndCityPieces.SectionGenerator() {
		...
		public boolean generate(
			...
			for(int k = 0; k < j; ++k) {
				endCityPiece2 = EndCityPieces.addHelper(
					list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(0, 4, 0), "tower_piece", rotation, true)
				);
			...
			if (endCityPiece3 != null) {
				for(Tuple<Rotation, BlockPos> tuple : EndCityPieces.TOWER_BRIDGES) {
					if (random.nextBoolean()) {
						EndCityPieces.EndCityPiece endCityPiece4 = EndCityPieces.addHelper(
							list, EndCityPieces.addPiece(structureManager, endCityPiece3, tuple.getB(), "bridge_end", rotation.getRotated((Rotation)tuple.getA()), true)
						);
				...
				endCityPiece2 = EndCityPieces.addHelper(
					list, EndCityPieces.addPiece(structureManager, endCityPiece2, new BlockPos(-1, 4, -1), "tower_top", rotation, true)
				);
			} else {
				if (i != 7) {
				...
				for(Tuple<Rotation, BlockPos> tuple : EndCityPieces.FAT_TOWER_BRIDGES) {
					if (random.nextBoolean()) {
						EndCityPieces.EndCityPiece endCityPiece3 = EndCityPieces.addHelper(
							list, EndCityPieces.addPiece(structureManager, endCityPiece2, tuple.getB(), "bridge_end", rotation.getRotated((Rotation)tuple.getA()), true)
						);
