...
public class NoiseSampler implements Climate.Sampler {
	...
	public NoiseSampler(int i, int j, int k, NoiseSettings noiseSettings, NoiseOctaves noiseOctaves, boolean bl, long l, WorldgenRandom.Algorithm algorithm) {
		...
		if (algorithm != WorldgenRandom.Algorithm.LEGACY) {
			...
			this.spaghetti2DElevationModulator = NormalNoise.create(
				positionalRandomFactory.fromHashOf("spaghetti_2d_elevation"), NOISE_MODULATOR_SPAGHETTI_2D_ELEVATION
			);
			...
			this.spaghetti2DThicknessModulator = NormalNoise.create(
				positionalRandomFactory.fromHashOf("spaghetti_2d_thickness"), NOISE_MODULATOR_SPAGHETTI_2D_THICKNESS
			);
			...
			this.spaghetti3DThicknessModulator = NormalNoise.create(
				positionalRandomFactory.fromHashOf("spaghetti_3d_thickness"), NOISE_MODULATOR_SPAGHETTI_3D_THICKNESS
			);
