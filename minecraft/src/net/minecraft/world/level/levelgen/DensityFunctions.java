	...
	protected static record Noise(Holder<NormalNoise.NoiseParameters> noiseData, @Nullable NormalNoise noise, @Deprecated double xzScale, double yScale)
		...
		public double compute(DensityFunction.FunctionContext functionContext) {
			return this.noise == null
				...
				: this.noise
					.getValue(
						(double)functionContext.blockX() * this.xzScale, (double)functionContext.blockY() * this.yScale, (double)functionContext.blockZ() * this.xzScale
					);
		}
		...
		public DensityFunction mapAll(DensityFunction.Visitor visitor) {
			return (DensityFunction)visitor.apply(
				new DensityFunctions.Spline(
					this.spline
						.mapAll(
							toFloatFunction -> (ToFloatFunction)(toFloatFunction instanceof TerrainShaper.CoordinateCustom coordinateCustom
