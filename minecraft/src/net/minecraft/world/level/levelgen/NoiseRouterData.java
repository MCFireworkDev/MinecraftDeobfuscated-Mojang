...
public class NoiseRouterData {
	...
	public static NoiseRouter createNoiseRouter(
		...
		DensityFunction densityFunction2 = DensityFunctions.noise(
			Noises.instantiate(registry, positionalRandomFactory, Noises.AQUIFER_FLUID_LEVEL_FLOODEDNESS), 0.67
		);
