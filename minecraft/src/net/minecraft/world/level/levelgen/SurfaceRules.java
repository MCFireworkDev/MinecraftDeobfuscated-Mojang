...
public class SurfaceRules {
	...
	protected static final class Context {
		...
		static class SteepMaterialCondition extends SurfaceRules.LazyCondition<SurfaceRules.Context.SteepMaterialCondition.State> {
			...
			static final class State extends Record {
				...
				public final String toString() {
					return ObjectMethods.bootstrap<"toString",SurfaceRules.Context.SteepMaterialCondition.State,"chunk;blockX;blockZ",SurfaceRules.Context.SteepMaterialCondition.State::chunk,SurfaceRules.Context.SteepMaterialCondition.State::blockX,SurfaceRules.Context.SteepMaterialCondition.State::blockZ>(
						this
					);
				}

				public final int hashCode() {
					return ObjectMethods.bootstrap<"hashCode",SurfaceRules.Context.SteepMaterialCondition.State,"chunk;blockX;blockZ",SurfaceRules.Context.SteepMaterialCondition.State::chunk,SurfaceRules.Context.SteepMaterialCondition.State::blockX,SurfaceRules.Context.SteepMaterialCondition.State::blockZ>(
						this
					);
				}

				public final boolean equals(Object object) {
					return ObjectMethods.bootstrap<"equals",SurfaceRules.Context.SteepMaterialCondition.State,"chunk;blockX;blockZ",SurfaceRules.Context.SteepMaterialCondition.State::chunk,SurfaceRules.Context.SteepMaterialCondition.State::blockX,SurfaceRules.Context.SteepMaterialCondition.State::blockZ>(
						this, object
					);
				}
		...
		static class TemperatureHelperCondition extends SurfaceRules.LazyCondition<SurfaceRules.Context.TemperatureHelperCondition.State> {
			...
			static final class State extends Record {
				...
				public final String toString() {
					return ObjectMethods.bootstrap<"toString",SurfaceRules.Context.TemperatureHelperCondition.State,"biome;blockX;blockY;blockZ",SurfaceRules.Context.TemperatureHelperCondition.State::biome,SurfaceRules.Context.TemperatureHelperCondition.State::blockX,SurfaceRules.Context.TemperatureHelperCondition.State::blockY,SurfaceRules.Context.TemperatureHelperCondition.State::blockZ>(
						this
					);
				}

				public final int hashCode() {
					return ObjectMethods.bootstrap<"hashCode",SurfaceRules.Context.TemperatureHelperCondition.State,"biome;blockX;blockY;blockZ",SurfaceRules.Context.TemperatureHelperCondition.State::biome,SurfaceRules.Context.TemperatureHelperCondition.State::blockX,SurfaceRules.Context.TemperatureHelperCondition.State::blockY,SurfaceRules.Context.TemperatureHelperCondition.State::blockZ>(
						this
					);
				}

				public final boolean equals(Object object) {
					return ObjectMethods.bootstrap<"equals",SurfaceRules.Context.TemperatureHelperCondition.State,"biome;blockX;blockY;blockZ",SurfaceRules.Context.TemperatureHelperCondition.State::biome,SurfaceRules.Context.TemperatureHelperCondition.State::blockX,SurfaceRules.Context.TemperatureHelperCondition.State::blockY,SurfaceRules.Context.TemperatureHelperCondition.State::blockZ>(
						this, object
					);
				}
	...
	static final class NoiseThresholdConditionState extends Record {
		final int blockX;
		final int blockZ;
		...
		public final String toString() {
			return ObjectMethods.bootstrap<"toString",SurfaceRules.NoiseThresholdConditionState,"blockX;blockZ",SurfaceRules.NoiseThresholdConditionState::blockX,SurfaceRules.NoiseThresholdConditionState::blockZ>(
				this
			);
		}

		public final int hashCode() {
			return ObjectMethods.bootstrap<"hashCode",SurfaceRules.NoiseThresholdConditionState,"blockX;blockZ",SurfaceRules.NoiseThresholdConditionState::blockX,SurfaceRules.NoiseThresholdConditionState::blockZ>(
				this
			);
		}

		public final boolean equals(Object object) {
			return ObjectMethods.bootstrap<"equals",SurfaceRules.NoiseThresholdConditionState,"blockX;blockZ",SurfaceRules.NoiseThresholdConditionState::blockX,SurfaceRules.NoiseThresholdConditionState::blockZ>(
				this, object
			);
		}
	...
	static final class YConditionState extends Record {
		final int blockY;
		...
		public final String toString() {
			return ObjectMethods.bootstrap<"toString",SurfaceRules.YConditionState,"blockY;stoneDepthAbove;stoneDepthBelow;runDepth;waterHeight",SurfaceRules.YConditionState::blockY,SurfaceRules.YConditionState::stoneDepthAbove,SurfaceRules.YConditionState::stoneDepthBelow,SurfaceRules.YConditionState::runDepth,SurfaceRules.YConditionState::waterHeight>(
				this
			);
		}

		public final int hashCode() {
			return ObjectMethods.bootstrap<"hashCode",SurfaceRules.YConditionState,"blockY;stoneDepthAbove;stoneDepthBelow;runDepth;waterHeight",SurfaceRules.YConditionState::blockY,SurfaceRules.YConditionState::stoneDepthAbove,SurfaceRules.YConditionState::stoneDepthBelow,SurfaceRules.YConditionState::runDepth,SurfaceRules.YConditionState::waterHeight>(
				this
			);
		}

		public final boolean equals(Object object) {
			return ObjectMethods.bootstrap<"equals",SurfaceRules.YConditionState,"blockY;stoneDepthAbove;stoneDepthBelow;runDepth;waterHeight",SurfaceRules.YConditionState::blockY,SurfaceRules.YConditionState::stoneDepthAbove,SurfaceRules.YConditionState::stoneDepthBelow,SurfaceRules.YConditionState::runDepth,SurfaceRules.YConditionState::waterHeight>(
				this, object
			);
		}
