		...
		MultiNoiseBiomeSourceSettings multiNoiseBiomeSourceSettings = BiomeSourceType.MULTI_NOISE
			...
			.setBiomes(
				ImmutableMap.of(
					...
					ImmutableList.<Biome.ClimateParameters>of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, -0.5F, 1.0F)),
					Biomes.SOUL_SAND_VALLEY,
					ImmutableList.<Biome.ClimateParameters>of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.5F, 1.0F)),
					Biomes.CRIMSON_FOREST,
					ImmutableList.<Biome.ClimateParameters>of(new Biome.ClimateParameters(0.0F, -0.5F, 0.0F, 0.0F, 1.0F)),
