...
public final class LevelStem {
	...
	public static boolean stable(long l, MappedRegistry<LevelStem> mappedRegistry) {
		...
		if (list.size() != BUILTIN_ORDER.size()) {
			...
			Entry<ResourceKey<LevelStem>, LevelStem> entry = (Entry)list.get(0);
			Entry<ResourceKey<LevelStem>, LevelStem> entry2 = (Entry)list.get(1);
			Entry<ResourceKey<LevelStem>, LevelStem> entry3 = (Entry)list.get(2);
