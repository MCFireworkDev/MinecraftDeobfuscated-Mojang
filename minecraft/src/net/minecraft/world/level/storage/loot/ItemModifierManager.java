		...
		map.forEach((resourceLocation, jsonElement) -> {
			try {
				if (jsonElement.isJsonArray()) {
					LootItemFunction[] lootItemFunctions = (LootItemFunction[])GSON.fromJson(jsonElement, LootItemFunction[].class);
				...
				LOGGER.error("Couldn't parse item modifier {}", resourceLocation, var4xx);
			}
		});
