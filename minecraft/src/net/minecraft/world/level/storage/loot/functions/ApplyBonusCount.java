...
public class ApplyBonusCount extends LootItemConditionalFunction {
		...
		public <T> DataResult<ApplyBonusCount.Formula> decode(DynamicOps<T> dynamicOps, MapLike<T> mapLike) {
			...
			return object == null
				...
				: ApplyBonusCount.FORMULA_TYPE_CODEC.decode(dynamicOps, object).flatMap(pair -> {
					...
					return ((ApplyBonusCount.FormulaType)pair.getFirst()).codec().decode(dynamicOps, objectxx).map(Pair::getFirst);
				});
		}
	...
	static final class OreDrops extends Record implements ApplyBonusCount.Formula {
		...
		public final boolean equals(Object object) {
			return ObjectMethods.bootstrap<"equals",ApplyBonusCount.OreDrops,"">(this, object);
		}
	}
