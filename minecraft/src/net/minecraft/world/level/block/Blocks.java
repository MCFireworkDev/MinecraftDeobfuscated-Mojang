...
public class Blocks {
	...
	public static final Block LIME_BED = register(
		"lime_bed", new BedBlock(DyeColor.LIME, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F))
	);
	public static final Block PINK_BED = register(
		"pink_bed", new BedBlock(DyeColor.PINK, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F))
	);
	public static final Block GRAY_BED = register(
		"gray_bed", new BedBlock(DyeColor.GRAY, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F))
	);
	...
	public static final Block CYAN_BED = register(
		"cyan_bed", new BedBlock(DyeColor.CYAN, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F))
	);
	...
	public static final Block BLUE_BED = register(
		"blue_bed", new BedBlock(DyeColor.BLUE, Block.Properties.of(Material.WOOL).sound(SoundType.WOOD).strength(0.2F))
	);
	...
	public static final Block RAIL = register(
		"rail", new RailBlock(Block.Properties.of(Material.DECORATION).noCollission().strength(0.7F).sound(SoundType.METAL))
	);
	...
	public static final Block REDSTONE_WALL_TORCH = register(
		...
		new RedstoneWallTorchBlock(
			Block.Properties.of(Material.DECORATION).noCollission().instabreak().lightLevel(7).sound(SoundType.WOOD).dropsLike(REDSTONE_TORCH)
		)
	);
	public static final Block STONE_BUTTON = register(
		"stone_button", new StoneButtonBlock(Block.Properties.of(Material.DECORATION).noCollission().strength(0.5F))
	);
	...
	public static final Block CACTUS = register(
		"cactus", new CactusBlock(Block.Properties.of(Material.CACTUS).randomTicks().strength(0.4F).sound(SoundType.WOOL))
	);
	...
	public static final Block MAGENTA_STAINED_GLASS = register(
		...
		new StainedGlassBlock(DyeColor.MAGENTA, Block.Properties.of(Material.GLASS, DyeColor.MAGENTA).strength(0.3F).sound(SoundType.GLASS))
	);
	...
	public static final Block ENDER_CHEST = register(
		"ender_chest", new EnderChestBlock(Block.Properties.of(Material.STONE).strength(22.5F, 600.0F).lightLevel(7))
	);
	...
	public static final Block POTTED_DANDELION = register(
		"potted_dandelion", new FlowerPotBlock(DANDELION, Block.Properties.of(Material.DECORATION).instabreak())
	);
	...
	public static final Block POTTED_RED_TULIP = register(
		"potted_red_tulip", new FlowerPotBlock(RED_TULIP, Block.Properties.of(Material.DECORATION).instabreak())
	);
	...
	public static final Block POTTED_DEAD_BUSH = register(
		"potted_dead_bush", new FlowerPotBlock(DEAD_BUSH, Block.Properties.of(Material.DECORATION).instabreak())
	);
	...
	public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = register(
		...
		new WeightedPressurePlateBlock(150, Block.Properties.of(Material.METAL).noCollission().strength(0.5F).sound(SoundType.WOOD))
	);
	public static final Block COMPARATOR = register(
		"comparator", new ComparatorBlock(Block.Properties.of(Material.DECORATION).instabreak().sound(SoundType.WOOD))
	);
	...
	public static final Block RED_CARPET = register(
		"red_carpet",
		new WoolCarpetBlock(DyeColor.RED, Block.Properties.of(Material.CLOTH_DECORATION, MaterialColor.COLOR_RED).strength(0.1F).sound(SoundType.WOOL))
	);
	...
	public static final Block TERRACOTTA = register(
		"terracotta", new Block(Block.Properties.of(Material.STONE, MaterialColor.COLOR_ORANGE).strength(1.25F, 4.2F))
	);
	...
	public static final Block BRICK_SLAB = register(
		"brick_slab", new SlabBlock(Block.Properties.of(Material.STONE, MaterialColor.COLOR_RED).strength(2.0F, 6.0F))
	);
	...
	public static final Block BELL = register(
		"bell", new BellBlock(Block.Properties.of(Material.METAL, MaterialColor.GOLD).strength(5.0F).sound(SoundType.ANVIL))
	);
