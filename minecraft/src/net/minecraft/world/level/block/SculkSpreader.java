		...
		private static boolean isMovementUnobstructed(Level level, BlockPos blockPos, BlockPos blockPos2) {
			if (blockPos.distManhattan(blockPos2) == 1) {
				...
				if (blockPos3.getX() == 0) {
					...
					return isUnobstructed(level, blockPos, direction) || isUnobstructed(level, blockPos, direction3);
				} else {
					return isUnobstructed(level, blockPos, direction) || isUnobstructed(level, blockPos, direction2);
				}
			}
		}
