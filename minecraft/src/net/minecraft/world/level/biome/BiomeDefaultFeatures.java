			...
			Feature.BAMBOO
				...
				.decorated(
					FeatureDecorator.TOP_SOLID_HEIGHTMAP_NOISE_BIASED
						.configured(new NoiseCountFactorDecoratorConfiguration(160, 80.0, 0.3, Heightmap.Types.WORLD_SURFACE_WG))
				)
		);
		biome.addFeature(
			GenerationStep.Decoration.VEGETAL_DECORATION,
	...
	public static void addSavannaExtraGrass(Biome biome) {
		biome.addFeature(
			...
			Feature.RANDOM_PATCH
				...
				.decorated(FeatureDecorator.COUNT_HEIGHTMAP_DOUBLE.configured(new FrequencyDecoratorConfiguration(20)))
		);
	}
