...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	public Biome getNoiseBiome(Climate.TargetPoint targetPoint) {
		return (Biome)((Supplier)this.parameters.findValue(targetPoint, (Supplier)() -> net.minecraft.data.worldgen.biome.Biomes.THE_VOID)).get();
	}
	...
	public static class Preset {
		...
		public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
			...
			registry -> new Climate.ParameterList(
					ImmutableList.of(
						Pair.of(Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.NETHER_WASTES)),
						Pair.of(Climate.parameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.SOUL_SAND_VALLEY)),
						Pair.of(Climate.parameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.CRIMSON_FOREST)),
						Pair.of(Climate.parameters(0.0F, 0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.375F), (Supplier)() -> registry.getOrThrow(Biomes.WARPED_FOREST)),
						Pair.of(Climate.parameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> registry.getOrThrow(Biomes.BASALT_DELTAS))
					)
				)
		);
		...
		MultiNoiseBiomeSource biomeSource(MultiNoiseBiomeSource.PresetInstance presetInstance, boolean bl) {
			Climate.ParameterList<Supplier<Biome>> parameterList = (Climate.ParameterList)this.parameterSource.apply(presetInstance.biomes());
