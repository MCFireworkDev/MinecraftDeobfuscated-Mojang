...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	public static final Codec<MultiNoiseBiomeSource> CODEC = Codec.mapEither(MultiNoiseBiomeSource.Preset.CODEC, DIRECT_CODEC)
		.<MultiNoiseBiomeSource>xmap(
			either -> either.map(pair -> ((MultiNoiseBiomeSource.Preset)pair.getFirst()).biomeSource(pair.getSecond()), Function.identity()),
	...
	private static MultiNoiseBiomeSource defaultNether(long l) {
		return new MultiNoiseBiomeSource(
			l,
			ImmutableList.of(
				Pair.of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.NETHER_WASTES),
				Pair.of(new Biome.ClimateParameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.SOUL_SAND_VALLEY),
				Pair.of(new Biome.ClimateParameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> Biomes.CRIMSON_FOREST),
				Pair.of(new Biome.ClimateParameters(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier)() -> Biomes.WARPED_FOREST),
				Pair.of(new Biome.ClimateParameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> Biomes.BASALT_DELTAS)
			),
