...
public class MultiNoiseBiomeSource extends BiomeSource {
	...
	public static ImmutableList<Pair<Biome.ClimateParameters, Supplier<Biome>>> parameters(Registry<Biome> registry) {
		return ImmutableList.of(Pair.of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.PLAINS)));
	}
	...
	public static class Preset {
		...
		public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
			...
			(preset, registry, long_) -> new MultiNoiseBiomeSource(
					long_,
					ImmutableList.of(
						Pair.of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.NETHER_WASTES)),
						Pair.of(new Biome.ClimateParameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.SOUL_SAND_VALLEY)),
						Pair.of(new Biome.ClimateParameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier)() -> registry.getOrThrow(Biomes.CRIMSON_FOREST)),
						Pair.of(new Biome.ClimateParameters(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier)() -> registry.getOrThrow(Biomes.WARPED_FOREST)),
						Pair.of(new Biome.ClimateParameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier)() -> registry.getOrThrow(Biomes.BASALT_DELTAS))
					),
