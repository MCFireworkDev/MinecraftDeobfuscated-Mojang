...
public record EntityTransform(EntityTransformType type, @Nullable Entity entity, @Nullable GameProfile playerSkin) {
	...
	public boolean canBreatheUnderwater() {
		if (this.entity == null) {
			...
			return var2 instanceof LivingEntity livingEntity ? livingEntity.canBreatheUnderwater() : true;
		}
	}

	public boolean canBreatheInAir() {
		Entity var2 = this.entity;
		return var2 instanceof LivingEntity livingEntity ? livingEntity.canTransformBreatheInAir() : true;
	}

	public boolean isSensitiveToWater() {
		Entity var2 = this.entity;
		if (var2 instanceof LivingEntity livingEntity && livingEntity.isSensitiveToWater()) {
			return true;
		}
