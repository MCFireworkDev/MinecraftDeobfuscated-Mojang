...
public class ModifiableAttributeInstance implements AttributeInstance {
	...
	public void addModifier(AttributeModifier attributeModifier) {
		if (this.getModifier(attributeModifier.getId()) != null) {
			...
			Set<AttributeModifier> set = (Set)this.modifiersByName.computeIfAbsent(attributeModifier.getName(), string -> Sets.newHashSet());
	...
	public void removeModifier(AttributeModifier attributeModifier) {
		...
		Set<AttributeModifier> set = (Set)this.modifiersByName.get(attributeModifier.getName());
		if (set != null) {
