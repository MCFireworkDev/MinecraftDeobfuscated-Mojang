				...
				return BehaviorBuilder.create(new BehaviorBuilder.TriggerWithResult<E, R>() {
					...
					public R tryTrigger(ServerLevel serverLevel, E livingEntity, long l) {
						...
						if (object == null) {
							...
							Function<A, R> function = (Function)triggerWithResult2.tryTrigger(serverLevel, livingEntity, l);
				...
				public R tryTrigger(ServerLevel serverLevel, E livingEntity, long l) {
					...
					if (object == null) {
						...
						if (object2 == null) {
							...
							BiFunction<A, B, R> biFunction = (BiFunction)triggerWithResult3.tryTrigger(serverLevel, livingEntity, l);
