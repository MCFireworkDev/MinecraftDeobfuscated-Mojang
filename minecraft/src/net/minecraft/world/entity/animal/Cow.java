...
public class Cow extends Animal {
	...
	public void aiStep() {
		Level f = this.level;
		if (f instanceof ServerLevel serverLevel) {
			...
			if (this.bloatCount > 0) {
				--this.bloatCount;
				float fx = this.getDimensions(Pose.STANDING).width / 2.0F;
				serverLevel.sendParticles(ParticleTypes.SMOKE, this.getX(), this.getY(), this.getZ(), 10, (double)fx, 0.0, (double)fx, 0.1);
