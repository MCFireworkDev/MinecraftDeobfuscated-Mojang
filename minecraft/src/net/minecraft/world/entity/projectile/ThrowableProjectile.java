...
public abstract class ThrowableProjectile extends Entity implements Projectile {
	...
	public void tick() {
		...
		if (this.owner == null) {
			...
			for(Entity entity : this.level.getEntities(this, aABB, entity -> !entity.isSpectator() && entity.isPickable())) {
		...
		Predicate<Entity> predicate = entity -> !entity.isSpectator() && entity.isPickable() && (this.leftOwner || !this.isEntityOrVehicle(entity, this.owner));
