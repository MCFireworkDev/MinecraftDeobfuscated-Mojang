	...
	static BitSetDiscreteVoxelShape join(
		...
		indexMerger.forMergedIndexes((i, j, k) -> {
			...
			boolean bl = indexMerger2.forMergedIndexes((l, m, n) -> {
				...
				boolean blxx = indexMerger3.forMergedIndexes((o, p, q) -> {
					boolean blxxx = booleanOp.apply(discreteVoxelShape.isFullWide(i, l, o), discreteVoxelShape2.isFullWide(j, m, p));
					if (blxxx) {
