...
public class IndirectEntityDamageSource extends EntityDamageSource {
	...
	public Component getLocalizedDeathMessage(LivingEntity livingEntity) {
		...
		ItemStack itemStack = string2 instanceof LivingEntity livingEntity2 ? livingEntity2.getMainHandItem() : ItemStack.EMPTY;
		String string = "death.attack." + this.msgId;
		if (!itemStack.isEmpty() && itemStack.hasCustomHoverName()) {
			String string2x = string + ".item";
			return Component.translatable(string2x, livingEntity.getDisplayName(), component, itemStack.getDisplayName());
		} else {
