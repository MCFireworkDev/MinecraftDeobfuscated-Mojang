...
public class ClientboundCommandsPacket implements Packet<ClientGamePacketListener> {
	...
	public ClientboundCommandsPacket(FriendlyByteBuf friendlyByteBuf) {
		...
		this.root = (RootCommandNode)((ClientboundCommandsPacket.Entry)list.get(i)).node;
	}
	...
	static class Entry {
		...
		public boolean build(List<ClientboundCommandsPacket.Entry> list) {
			...
			for(int i : this.children) {
				CommandNode<SharedSuggestionProvider> commandNode = ((ClientboundCommandsPacket.Entry)list.get(i)).node;
				if (!(commandNode instanceof RootCommandNode)) {
