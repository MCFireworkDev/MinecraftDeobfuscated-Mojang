...
public class Rules {
	...
	public static final BooleanRule TEST_RULE_PLEASE_IGNORE = register(
		"test_rule_please_ignore", 7, new BooleanRule(Component.literal("TEST RULE PLEASE IGNORE"))
	);
	...
	public static final BooleanRule WHEELS_ON_MINECARTS = register(
		"wheels_on_minecarts", 500, new BooleanRule(Component.translatable("rule.wheels_on_minecarts"))
	);
	...
	public static final BooleanRule ROWING_UP_THAT_HILL = register(
		"rowing_up_that_hill", 500, new BooleanRule(Component.translatable("rule.rowing_up_that_hill"))
	);
	...
	public static final BooleanRule TRANSPARENT_PLAYERS = register(
		"transparent_players", 500, new BooleanRule(Component.translatable("rule.transparent_players"))
	);
	...
	public static final BooleanRule GLOWING_GLOW_SQUIDS = register(
		"glowing_glow_squids", 500, new BooleanRule(Component.translatable("rule.glowing_glow_squids"))
	);
	...
	public static final BooleanRule ONLY_MENDING_TRADES = register(
		"only_mending_trades", 500, new BooleanRule(Component.translatable("rule.only_mending_trades"))
	);
