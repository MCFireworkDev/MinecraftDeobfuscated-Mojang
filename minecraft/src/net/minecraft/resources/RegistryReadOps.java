...
public class RegistryReadOps<T> extends DelegatingOps<T> {
	...
	private <E> DataResult<Supplier<E>> readAndRegisterElement(
		...
		if (dataResult != null) {
			...
			if (!optional.isPresent()) {
				dataResult2 = DataResult.success((Supplier)() -> writableRegistry.get(resourceKey2), Lifecycle.stable());
			} else {
				...
				if (optional2.isPresent()) {
					...
					writableRegistry.registerOrOverride((OptionalInt)pair.getSecond(), resourceKey2, pair.getFirst(), dataResult3.lifecycle());
				}
