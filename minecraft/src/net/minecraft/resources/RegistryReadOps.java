	...
	private <E> DataResult<Supplier<E>> readAndRegisterElement(
		...
		if (dataResult != null) {
			...
			if (optional.isEmpty()) {
				...
				DataResult<RegistryResourceAccess.ParsedEntry<E>> dataResult3 = (DataResult)optional.get();
				Optional<RegistryResourceAccess.ParsedEntry<E>> optional2 = dataResult3.result();
				if (optional2.isPresent()) {
					RegistryResourceAccess.ParsedEntry<E> parsedEntry = (RegistryResourceAccess.ParsedEntry)optional2.get();
