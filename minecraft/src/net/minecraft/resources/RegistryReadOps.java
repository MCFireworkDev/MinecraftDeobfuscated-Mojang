...
public class RegistryReadOps<T> extends DelegatingOps<T> {
	...
	public <E> DataResult<MappedRegistry<E>> decodeElements(
		MappedRegistry<E> mappedRegistry, ResourceKey<? extends Registry<E>> resourceKey, MapCodec<E> mapCodec
	) {
		...
		if (object != null) {
			...
			if (dataResult != null) {
				...
				Supplier<E> supplier = Suppliers.memoize(() -> {
					E objectxx = writableRegistry.get(resourceKey2);
					if (objectxx == null) {
