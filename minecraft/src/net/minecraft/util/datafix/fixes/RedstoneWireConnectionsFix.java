		...
		return !bl
			...
			: dynamic.update(
				...
				dynamicx -> {
					...
					boolean blxx = isConnected(string) || isConnected(string2);
					...
					String string7 = !isConnected(string3) && !blxx ? "side" : string3;
					String string8 = !isConnected(string4) && !blxx ? "side" : string4;
