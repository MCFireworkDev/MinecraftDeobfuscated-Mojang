...
public class V2501 extends NamespacedSchema {
	...
	public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map2) {
		...
		Map<String, Supplier<TypeTemplate>> map3 = ImmutableMap.builder()
			...
			.put(
				"flat",
				(Supplier)() -> DSL.optionalFields("biome", References.BIOME.in(schema), "layers", DSL.list(DSL.optionalFields("block", References.BLOCK_NAME.in(schema))))
			)
			.put(
				"buffet",
